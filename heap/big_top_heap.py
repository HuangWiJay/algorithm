class Heap:
    ...
    @classmethod
    def _parent(cls,child_index:int):
        return child_index // 2

    @classmethod
    def _left(cls,parent_index:int):
        return 2 * parent_index

    @classmethod
    def _right(cls,parent_index:int):
    ...
    @classmethod
    def _siftdown(cls,a:list,count:int,root_index:int = 1):
